...
// Re-defining the Project interface for the client component
...
export default function ProjectClient({ project, slug }: { project: Project; slug: string }) {
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 flex flex-col justify-center h-full text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            <div className="space-y-6">
              <p className="text-gray-300 leading-relaxed" dangerouslySetInnerHTML={{ __html: project.fullDescription }} />
            </div>
            
            {/* Project Images */}
            <div className="project-images space-y-8 mt-12">
              {project.images.map((image, i) => (
                <div key={i}>
                  {image.startsWith('<') ? (
                    <div dangerouslySetInnerHTML={{ __html: image }} className="w-full" />
                  ) : (
                    <div className="project-image-container relative w-full h-auto aspect-video rounded-xl shadow-lg bg-gray-100 dark:bg-gray-800 overflow-hidden">
                      <Image
                        src={image}
